...
//static void LCD_bar(void);
static void LCD_Clock_Init(void);
static void LCD_PIN_Init(void);
static void LCD_Configure(void);
static void LCD_Clear(void);
//static void LCD_DisplayName(void);
static void LCD_WriteChar(uint8_t* ch, bool point, bool colon, uint8_t position);
...
static void LCD_DisplayName(void){
	...
	LCD->RAM[0] = 0xF482C048;
	LCD->RAM[1] |= 0xF;
	LCD->RAM[2] = 0x65C05278;
	LCD->RAM[3] &= ~ 0xF;
	LCD->RAM[3] |= 0x7;
